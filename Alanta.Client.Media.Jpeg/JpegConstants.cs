...
namespace Alanta.Client.Media.Jpeg
{
    ...
    {
        public const IdctImplementation SelectedIdct = IdctImplementation.NVidia;
        // public const IdctImplementation SelectedIdct = IdctImplementation.Naive;
    ...
    public enum IdctImplementation
    {
        Naive,
        AAN,
        NVidia
