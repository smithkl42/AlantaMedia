...
namespace Alanta.Client.Media.Tests
{
	[TestClass]
	public class AudioCodecTests : SilverlightTest
	{
		...
		public void G711Test()
		{
			...
			var encoded = new short[_audioFormat.SamplesPerFrame / 4];
			var output = new short[_audioFormat.SamplesPerFrame];
			var encoder = new G711MuLawEncoder(_audioFormat);
			var decoder = new G711MuLawDecoder(_audioFormat);
